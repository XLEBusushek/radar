...
| Параметр | Описание |
|----------|----------|
| `demoMode` | режим демонстрации: `"small"` (4 цели), `"medium"` (14), `"full"` (28) |
| `numFalse` | количество ложных целей (птиц) |
| `numGround` | количество наземных целей |
| `numAirplaneUAV` | количество самолётных БПЛА |
| `numQuadcopter` | количество квадрокоптеров |
| `boxSize` | размер области моделирования `[X Y Z]`, м (по умолчанию `[2000, 2000, 500]`) |
...
Базовая область для всех режимов: `boxSize = [2000, 2000, 500]`.

| Режим | False | Ground | Airplane | Quadcopter | Всего | `duration`, с |
|-------|-------|--------|----------|------------|-------|---------------|
| `small` | 1 | 1 | 1 | 1 | 4 | 300 |
| `medium` | 6 | 3 | 2 | 3 | 14 | 300 |
| `full` | 12 | 6 | 4 | 6 | 28 | 360 |
